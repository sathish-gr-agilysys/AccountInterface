...
public interface AccountServiceInterfaceV1 {
    ...
    String ACCOUNTS_TAX_FACTS = "/accountsTaxFacts";
    ...
    String UPDATE_ACCOUNT_DETAILS = "/updateHouseAccountDetails";
    ...
    @PUT
    @Path(ACCOUNT_ID_PATH + ACCOUNTS_TAX_FACTS)
    @Requires(Permission.WRITE_ACCOUNTS)
    void updateGroupAccountTaxFacts(@PathParam(TENANT_ID) String tenantId,
          @PathParam(PROPERTY_ID) String propertyId, @PathParam(ACCOUNT_ID) String accountId,
    ...
    @PUT
    @Path(ACCOUNT_ID_PATH + UPDATE_ACCOUNT_DETAILS)
    AccountDetail updateHouseAccountDetails(@PathParam(TENANT_ID) String tenantId, @PathParam(PROPERTY_ID) String propertyId,
          @PathParam(ACCOUNT_ID) String accountId, @QueryParam("creditLimit") BigDecimal creditLimit,
          @QueryParam("pointOfSaleForHouseAccount") Boolean pointOfSaleForHouseAccount) throws RGuestException;
}
